    ...
    <el-card class="box-card">
      ...
      <el-form label-width="100px">
        <el-row :gutter="5">
          ...
          <el-col :xs="12" :sm="8" :md="8" :lg="6" :xl="4">
            <el-form-item label="自动更新内核">
              <el-switch
                v-on:change="SaveUIFConfig()"
                v-model="uif.config.autoUpdateCore"
              >
              </el-switch>
            </el-form-item>
          </el-col>
    ...
    <el-card class="box-card">
      ...
      <el-form label-width="100px">
        <el-row :gutter="5">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
            <el-form-item label="UIF 更新地址">
              <el-autocomplete
                value-key="name"
                v-model="uif.config.uifUpdateAddress"
                @change="SaveUIFConfig()"
                :disabled="true"
                :fetch-suggestions="queryUIF"
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
            <el-form-item label="内核更新地址">
              <el-autocomplete
                value-key="name"
                v-model="uif.config.coreUpdateAddress"
                @change="SaveUIFConfig()"
                :fetch-suggestions="queryCore"
                @select="SaveUIFConfig()"
                placeholder="请输入内容"
              ></el-autocomplete>
            </el-form-item>
        ...
        <el-row :gutter="5">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6">
            <el-form-item label="端口">
              <el-autocomplete
                v-model="uif.config.ntp.server_port"
                @change="SaveAndApply()"
                placeholder="必填"
              ></el-autocomplete>
            </el-form-item>
