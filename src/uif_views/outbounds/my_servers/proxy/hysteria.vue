    ...
    <el-row :gutter="5">
      ...
      <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
        <el-form-item label="recv_window_conn">
          <el-input
            placeholder="必填"
            v-model="outbound_obj.setting.recv_window_conn"
          >
          </el-input>
        </el-form-item>
      </el-col>
      ...
      >
        <el-form-item label="recv_window">
          <el-input
            placeholder="必填"
            v-model="outbound_obj.setting.recv_window"
          >
            <template slot="append">Mbps</template>
          </el-input>
        </el-form-item>
      ...
      >
        <el-form-item label="max_conn_client">
          <el-input
            placeholder="必填"
            v-model="outbound_obj.setting.max_conn_client"
          >
          </el-input>
        </el-form-item>
      </el-col>
