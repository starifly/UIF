...
export function SetSession(content) {
  ...
  for (var item in allSession) {
    ...
    if (item['value'] == content['value'] && item['password'] == content['password']) {
      return
    }
  }
  allSession.push(content)
  console.log(allSession)
  return Cookies.set(LoginSession, JSON.stringify(allSession), {
    expires: 30
  })
}
...
export var DELAY_TIMEOUT = 13000
